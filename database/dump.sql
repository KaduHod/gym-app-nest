...
INSERT INTO `alunos` VALUES (40,80,NULL);
...
CREATE TABLE `articulation_movement_muscle_portion` (
  ...
  PRIMARY KEY (`id`),
  KEY `muscle_portion_articulation_movement_muscle_portion` (`muscle_portion_id`),
...
INSERT INTO `personais` VALUES (21,81),(22,82);
...
INSERT INTO `users` VALUES (80,'Natasha','Arnilloy','nathy.mocerino@g23mai4l3.com','carloslindo','041 99999-4444','2023-04-22 01:54:23',NULL,NULL),(81,'Carlos ALberto PEROSNALLL','kaduhodAluns','carlosjr.ribas@gmail.com','12345689','041 99999-4444','2023-04-22 01:55:31',NULL,'1998-12-10 00:00:00.000'),(82,'Carlos ALberto PEROSNALLL','kaduho2dAluns','carlosjr.riba2s@gmail.com','12345689','041 99999-4444','2023-04-22 02:38:30',NULL,'1998-12-10 00:00:00.000');
...
INSERT INTO `users_permission` VALUES (1,80),(2,81),(2,82);
...
-- Dump completed on 2023-04-23 12:48:37
